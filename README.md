...
You can also rerun `Publish Homebrew Tap` manually from GitHub Actions by providing a tag such as `0.2.12` or `v0.2.12`.
...
You can also rerun `Publish APT Repository` manually from GitHub Actions by providing a tag such as `0.2.12` or `v0.2.12`.
...
You can also rerun `Publish WinGet Package` manually from GitHub Actions by providing a tag such as `0.2.12` or `v0.2.12`.

You can also trigger the `Create Release Tag` workflow from GitHub Actions.
Enter `0.2.12` or `v0.2.12` as the input, and it will:
...
Enter `0.2.12` or `v0.2.12`, and it will:
